...
final class AdminMenu {
	...
	public function add_menu(): void {
		...
		// Setup wizard is registered as a hidden page (per CLAUDE.md §2 file
		// layout: SetupWizardPage). The Notices manager surfaces a banner
		// linking here while setup is incomplete.
		add_submenu_page(
			'options.php',
